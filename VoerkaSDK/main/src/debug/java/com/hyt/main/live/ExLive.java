 ...
 */
public class ExLive extends BasicModule {
    ...
    private void initView() {
        contentView = LayoutInflater.from(contetxt).inflate(R.layout.activity_live, parentCenter, true);
    }
