...
import com.hyt.base.module.event.ModuleImpl;
 ...
 */
public class ExChat extends BasicModule implements ModuleImpl {
    ...
    private void initView() {
        contentView = LayoutInflater.from(contetxt)
                .inflate(R.layout.activity_chat, parentBottom, true);
    }
