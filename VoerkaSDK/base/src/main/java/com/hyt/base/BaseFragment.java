...
public class BaseFragment extends Fragment {
    ...
    public void onAttach(Context context) {
        Log.d(tag, "Fragment:" + tag
                + ":onAttach:Fragment与Activity建立关联时被调用，"
                + "用于获得Activity传递的值:Fragment创建(1)");
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        Log.d(tag, "Fragment:" + tag
                + ":onActivityCreated:在初始化onCreateView方法的视图后返回时被调用:Fragment创建(4)");
    ...
    public void onPause() {
        Log.d(tag, "Fragment:" + tag
                + ":Common:onPause:Fragment进入后台不可见状态(1):Fragment销毁(1)");
        super.onPause();
    }
    ...
    public void onStop() {
        Log.d(tag, "Fragment:" + tag
                + ":Common:onStop:Fragment进入后台不可见状态(2):Fragment销毁(2)");
        super.onStop();
    }
    ...
    public void onDestroyView() {
        Log.d(tag, "Fragment:" + tag
                + ":onDestroyView:在Fragment视图被移除时调用:Fragment销毁(3)");
        super.onDestroyView();
    }
    ...
    public void onDetach() {
        Log.d(tag, "Fragment:" + tag
                + ":onDetach:Fragment与Activity的关联被取消时调用:Fragment销毁(5)");
        super.onDetach();
    }
}
